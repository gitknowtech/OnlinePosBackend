...
DROP TABLE IF EXISTS `delete_suppliers`;
...
LOCK TABLES `delete_suppliers` WRITE;
/*!40000 ALTER TABLE `delete_suppliers` DISABLE KEYS */;
/*!40000 ALTER TABLE `delete_suppliers` ENABLE KEYS */;
UNLOCK TABLES;
